...
# de generaties worden door de pickle herrinert en de data van die vogels worden dus getransporteert naar andere.
...
def run(config_file):
    ...
    # dit laat de score aan het einde zien
    ...
    with open("best_ge.pickle", "rb") as f:
        ge = [pickle.load(f)] # dit laad de genomes van de file best_ge.pickle
